...
**Impact**: Put our names on the map in Pakistan's tech scene and opened doors we never expected.

---

## Chat Analysis App
**Finding Patterns in Digital Conversations**
...
### Mentoring & Meetups
- Organizing coding meetups and events
...
## Current Focus
**Building Things People Really Want**

Following the Y Combinator mantra: "Make stuff that people really want." Currently working on several projects (some under NDA) that focus on:

- **End-to-end product development**: From design to deployment
- **Community building**: Creating spaces for learning and growth
- **Marketing & outreach**: Helping great products find their audience
- **Rapid prototyping**: Using modern tools to build weekend projects that deliver real value
...
### Weekend Warriors
With tools like Cursor, I can now build meaningful solutions over a weekend that can bring real value and return. The pace of development has changed everything.

### Passion to the Point of Madness
Whatever I'm working on, I believe in being passionate about it to the point of "madness and craze." That's when the best work happens.
...
*Want to collaborate on something amazing? The fire is always burning for new ideas and partnerships.*
...
**Always Learning**: VR development, new frameworks, and whatever technology can help create better experiences for users.

---

*Every project is a chance to make something that matters. What will we build together?* 